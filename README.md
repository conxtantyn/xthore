...
- **Swagger Documentation**: [http://localhost:8090/swagger-ui/index.html](http://localhost:8090/swagger-ui/index.html) for accessing specific services using the `q` query parameter, e.g;
  - [Catalog service](http://localhost:8090/swagger-ui/index.html?q=catalog) `http://localhost:8090/swagger-ui/index.html?q=catalog`
  - [Order service](http://localhost:8090/swagger-ui/index.html?q=order) `http://localhost:8090/swagger-ui/index.html?q=order`
